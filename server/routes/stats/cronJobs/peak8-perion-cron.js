...
const { Notifications, db } = require('../../../services/arango');
const request = require('request');
const aql = require('arangojs').aql;

//Cron Job Peak 8 Perion function
async function peak8PerionStatCronJob() {
    console.log('Peak 8 Media Perion Cron Job start!');
    ...
    let companyAql = `FOR company in companies FILTER company.name == "Peak 8 Media" FOR provider IN company.reportingProviders FILTER provider.reportingProvider == "perion" RETURN company`
    try {
    ...
    console.log('Peak 8 Perion Cron Job End!');
}
