...
//Cron Job Manic Traffic Perion function
async function manicPerionStatCronJob() {
    console.log('Manic Traffic Perion Cron Job start!');
    ...
    let companyAql = `FOR company in companies FILTER company.name == "Manic Traffic" FOR provider IN company.reportingProviders FILTER provider.reportingProvider == "perion" RETURN company`
    try {
    ...
    console.log('Manic Traffic Perion Cron Job End!');
}
