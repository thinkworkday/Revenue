...
async function apexPerionStatCronJob() {
    console.log('Apex Perion Cron Job start!');
    ...
    let companyAql = `FOR company in companies FILTER company.name == "Apex Extensions" FOR provider IN company.reportingProviders FILTER provider.reportingProvider == "perion" RETURN company`
    try {
    ...
    console.log('Apex Perion Cron Job End!');
}
