...
async function brandclickPerionStatCronJob() {
    console.log('BrandClick Perion Cron Job start!');
    ...
    console.log('BrandClick Perion Cron Job End!');
}
