        ...
        if (tagL.tag.advertiser == "verizon-direct") {
          for (var tagSub of tagL.tag.subids) {
            if (tagSub.filterTag == "Contains") {
              ...
              this.allChartStat.map((stat: { subid: string | any[]; publisher: any; tagname: any; }) => {
              ...
              this.allChartStat.map((stat_1: { subid: string; publisher: any; tagname: any; }) => {
              ...
              this.allChartStat.map((stat_2: { subid: string; publisher: any; tagname: any; }) => {
              ...
              this.allChartStat.map((stat_3: { subid: any; publisher: any; tagname: any; }) => {
